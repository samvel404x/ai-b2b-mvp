      ...
      <div className="flex flex-col gap-6 animate-fade-in">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex flex-col gap-3 rounded-2xl border border-[#ffffff08] bg-[#0a0c0b] p-5">
        ...
        <div className="rounded-2xl border border-[#ffffff08] bg-[#0a0c0b] p-6">
