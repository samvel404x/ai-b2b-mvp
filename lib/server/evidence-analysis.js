...
// Main upload pipeline: validate file, run Gemini/fallback extraction, and return a review record.
export async function analyzeEvidenceFile(file, source = "Data Intake") {
