...
export function buildDiagnostics({ evidence = [], liveEvents = [], findings = [], actions = [], proofGraph = { trail: [] } } = {}) {
...
export function syncDerivedWorkspaceData(workspace) {
  ...
  const diagnostics = buildDiagnostics({ evidence, liveEvents, findings, actions, proofGraph: proofGraphBeforeReports });
