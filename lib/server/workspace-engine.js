...
export function syncDerivedWorkspaceData(workspace) {
  ...
  const reportWorkspace = { ...workspace, ...businessEntities, findings, actions, agentRuns, notifications };
  ...
  return {
    ...
    metrics: summarizeWorkspace({ ...workspace, ...businessEntities, findings, actions, reports, agentRuns, notifications }),
  };
}
