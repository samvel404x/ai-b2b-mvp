...
export const healthMetrics = [
  {
    ...
    spark: [62, 64, 63, 68, 70, 69, 73, 74, 76, 78],
  },
  {
    id: "risk",
    label: "Money at risk",
    ...
    spark: [90, 96, 102, 99, 108, 114, 112, 120, 124, 128],
  },
  {
    id: "savings",
    ...
    spark: [40, 44, 48, 46, 52, 55, 58, 60, 62, 64],
  },
  {
    id: "coverage",
    ...
    spark: [68, 70, 71, 74, 73, 76, 78, 79, 81, 82],
  },
  {
    id: "confidence",
    label: "AI confidence",
    ...
    spark: [84, 85, 87, 86, 88, 89, 88, 90, 90, 91],
  },
];

export const commandActivity = [
  { id: "act1", agent: "Contract Sentinel", text: "flagged Acme auto-renewal window", time: "2m ago", tone: "critical" },
  { id: "act2", agent: "Spend Auditor", text: "found duplicate research seats", time: "18m ago", tone: "warning" },
  { id: "act3", agent: "Invoice Reconciler", text: "matched INV-2291 to contract rate", time: "41m ago", tone: "evidence" },
  { id: "act4", agent: "Governance Keeper", text: "requested owners for 14 charges", time: "1h ago", tone: "warning" },
  { id: "act5", agent: "Spend Auditor", text: "closed Datadog seat opportunity", time: "3h ago", tone: "primary" },
];
