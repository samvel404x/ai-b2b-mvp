...
export const evidenceGraphNodes = {
  sourceEvidence: {
    count: 95, label: "Source evidence",
    items: [
      { label: "Microsoft_EA_Renewal_Quote.pdf", sub: "Contract • May 23, 2026", score: 94, icon: "pdf", status: "" },
      { label: "Contracts_Master.xlsx", sub: "Excel • May 21, 2026", score: 89, icon: "excel", status: "" },
      { label: "AP_Invoices_May.xlsx", sub: "Excel • May 24, 2026", score: 85, icon: "excel", status: "" },
      { label: "Vendor_Benchmark_Report.pdf", sub: "PDF • May 22, 2026", score: 82, icon: "pdf", status: "" },
    ]
  },
  extractedFacts: {
    count: 2841, label: "Extracted facts",
    items: [
      { label: "Microsoft EA renewal", sub: "Term: 12 months", score: 95, icon: "fact", status: "" },
      { label: "Payment terms", sub: "Net 30", score: 96, icon: "fact", status: "" },
      { label: "Price per user", sub: "$182.00", score: 94, icon: "fact", status: "" },
      { label: "Auto-renewal", sub: "Yes", score: 93, icon: "fact", status: "" },
    ]
  },
  diagnosticRisks: {
    count: 34, label: "Diagnostic risks", color: "critical",
    items: [
      { label: "Renewal above market", sub: "High • $245K", score: 94, icon: "risk", status: "", highlight: true },
      { label: "Unused licenses", sub: "Medium • $120K", score: 88, icon: "risk", status: "" },
      { label: "Payment terms drift", sub: "Medium • $27K", score: 78, icon: "risk", status: "" },
      { label: "Duplicate payments", sub: "High • $48K", score: 92, icon: "risk", status: "" },
    ]
  },
  agentActions: {
    count: 87, label: "Agent actions",
    items: [
      { label: "Contract Analyst", sub: "Review & benchmark", score: 92, icon: "agent", status: "In progress" },
      { label: "Spend Auditor", sub: "Negotiate renewal", score: 88, icon: "agent", status: "In progress" },
      { label: "Finance Watcher", sub: "Validate terms", score: 85, icon: "agent", status: "Queued" },
      { label: "Legal Reviewer", sub: "Check clauses", score: 80, icon: "agent", status: "Queued" },
    ]
  },
  humanApprovals: {
    count: 24, label: "Human approvals",
    items: [
      { label: "Michael Wong", sub: "Procurement", score: 92, icon: "user", status: "Review" },
      { label: "Sarah Green", sub: "Finance Manager", score: 67, icon: "user", status: "Savings" },
      { label: "James Tran", sub: "CFO", score: 48, icon: "user", status: "Due 2h 5m" },
      { label: "Alex Rivera", sub: "Owner", score: null, icon: "user", status: "Due 4h 32m" },
    ]
  },
  boardReports: {
    count: 12, label: "Board reports",
    items: [
      { label: "Weekly Risk Report", sub: "May 12 – May 18", score: 95, icon: "report", status: "Included" },
      { label: "Savings Summary", sub: "Top savings", score: 93, icon: "report", status: "Included" },
      { label: "Renewal Risk Report", sub: "Upcoming renewals", score: 90, icon: "report", status: "Included" },
      { label: "Executive Summary", sub: "May 2026", score: 90, icon: "report", status: "Included" },
    ]
  },
};
...
export const excelKpis = [
  { id: "rows", label: "Rows Processed", value: "1.42M", trend: "24.6% vs last 7 days", trendDir: "up", tone: "primary", ring: 75, spark: [10, 12, 14, 18, 24, 28, 30] },
  { id: "spend", label: "Spend Analyzed", value: "$6.21M", trend: "8.7% vs last 7 days", trendDir: "up", tone: "primary", ring: 60, spark: [5, 6, 8, 9, 10, 11, 12] },
  { id: "dupes", label: "Duplicate Payments", value: "95", trend: "19 vs last 7 days", trendDir: "up", tone: "critical", ring: 85, spark: [2, 4, 3, 5, 8, 12, 19] },
  { id: "forecast", label: "Forecast Variance", value: "-$430K", trend: "-5.1% vs forecast", trendDir: "down", tone: "evidence", ring: 65, spark: [20, 18, 15, 12, 10, 8, 5] },
  { id: "margin", label: "Margin Risk", value: "$1.21M", trend: "15.6% vs last 7 days", trendDir: "up", tone: "warning", ring: 70, spark: [5, 7, 6, 8, 10, 12, 15] },
  { id: "missing", label: "Missing Values", value: "8,771", trend: "-8.3% vs last 7 days", trendDir: "down", tone: "warning", ring: 45, spark: [30, 28, 25, 22, 18, 15, 12] },
  { id: "formula", label: "Formula Issues", value: "241", trend: "31 vs last 7 days", trendDir: "up", tone: "warning", ring: 55, spark: [8, 10, 15, 12, 18, 24, 31] },
  { id: "open", label: "Open Approval Value", value: "$1.84M", trend: "3 approvals", trendDir: "flat", tone: "warning", ring: 40, spark: [1, 1, 2, 2, 3, 3, 3] },
  { id: "export", label: "Export Readiness", value: "96%", trend: "12% vs last 7 days", trendDir: "up", tone: "primary", ring: 96, spark: [70, 75, 80, 85, 90, 92, 96] },
];
...
export const excelSpendByCategory = [
  { category: "Software", amount: 420, pct: 34.7, color: "#e84142" },
  { category: "Marketing", amount: 310, pct: 25.6, color: "#f97316" },
  { category: "Consulting", amount: 180, pct: 14.9, color: "#eab308" },
  { category: "Office Supplies", amount: 120, pct: 9.9, color: "#10b981" },
  { category: "Travel", amount: 95, pct: 7.8, color: "#3b82f6" },
  { category: "Other", amount: 85, pct: 7.0, color: "#8b5cf6" },
];
...
export const agentRunHistory = [
  { time: "10:42 AM", status: "completed", outputs: 23, incidents: 0, duration: "2m 14s" },
  { time: "10:35 AM", status: "blocked", outputs: 4, incidents: 2, duration: "Blocked" },
  { time: "10:21 AM", status: "completed", outputs: 19, incidents: 0, duration: "2m 02s" },
  { time: "10:15 AM", status: "failed", outputs: 0, incidents: 1, duration: "Error" },
  { time: "10:01 AM", status: "completed", outputs: 17, incidents: 0, duration: "2m 31s" },
  { time: "09:40 AM", status: "completed", outputs: 21, incidents: 0, duration: "3m 10s" },
  { time: "09:25 AM", status: "blocked", outputs: 7, incidents: 1, duration: "Blocked" },
...
export const approvalsQueue = [
  ...
  { id: "AQ-009", priority: "High",   urgency: "Urgent",   title: "Approve vendor contract renewal", sub: "TechSoft Solutions – 12mo renewal",  impact: 245000, impactStr: "$245K", impactSub: "Save 15-20%",   owner: "Michael Wong", ownerRole: "Procurement", evidenceDocs: 12, proofTrail: "PT-1247", status: "Urgent",   due: "14m overdue",        dueUrgent: true,  agent: "Contract Analyst",  agentVer: "v2.3", confidence: 92 },
  { id: "AQ-010", priority: "Medium", urgency: "Due soon", title: "Increase marketing ad spend",      sub: "Google Ads – Q4 campaign",           impact: 120000, impactStr: "$120K", impactSub: "Est. impact",   owner: "Sarah Green",  ownerRole: "Marketing",   evidenceDocs: 8,  proofTrail: "PT-1245", status: "Due soon", due: "1h 12m",             dueUrgent: false, agent: "Spend Auditor",     agentVer: "v1.8", confidence: 89 },
  { id: "AQ-011", priority: "High",   urgency: "Due soon", title: "Write off aged receivable",        sub: "Acme Corp – $42,500",                impact: 42500,  impactStr: "$42.5K",impactSub: "Write-off",     owner: "Daniel Tran",  ownerRole: "Finance",     evidenceDocs: 6,  proofTrail: "PT-1243", status: "Due soon", due: "2h 5m",              dueUrgent: false, agent: "Finance Watcher",   agentVer: "v2.1", confidence: 85 },
  { id: "AQ-012", priority: "Low",    urgency: "Review",   title: "Approve new vendor onboarding",    sub: "CloudScale LLC",                     impact: 18000,  impactStr: "$18K",  impactSub: "First year",    owner: "James Silva",  ownerRole: "Procurement", evidenceDocs: 9,  proofTrail: "PT-1241", status: "Review",   due: "4h 32m",             dueUrgent: false, agent: "Vendor Risk",       agentVer: "v1.6", confidence: 81 },
  { id: "AQ-013", priority: "Medium", urgency: "Review",   title: "Discount approval – Enterprise deal",sub: "Northwind – 15% discount",          impact: 85000,  impactStr: "$85K",  impactSub: "Est. impact",   owner: "Lisa Morgan",  ownerRole: "Sales",       evidenceDocs: 7,  proofTrail: "PT-1239", status: "Review",   due: "5h 10m",             dueUrgent: false, agent: "Deal Approver",     agentVer: "v1.9", confidence: 78 },
  { id: "AQ-014", priority: "Medium", urgency: "Review",   title: "Budget reallocation – Q4",         sub: "Events → Content",                   impact: 60000,  impactStr: "$60K",  impactSub: "Reallocate",    owner: "Arjun Kapoor", ownerRole: "Marketing",   evidenceDocs: 5,  proofTrail: "PT-1237", status: "Review",   due: "7h 45m",             dueUrgent: false, agent: "Budget Optimizer",  agentVer: "v2.0", confidence: 75 },
  { id: "AQ-015", priority: "Low",    urgency: "Snoozed",  title: "Approve PO increase",               sub: "Office Depot – PO #88912",          impact: 22000,  impactStr: "$22K",  impactSub: "Increase",      owner: "Michael Wong", ownerRole: "Procurement", evidenceDocs: 6,  proofTrail: "PT-1235", status: "Snoozed",  due: "Tomorrow 9:00 AM",   dueUrgent: false, agent: "Procure Guard",     agentVer: "v1.7", confidence: 76 },
  { id: "AQ-016", priority: "Medium", urgency: "Review",   title: "SaaS license renewal",              sub: "Datadog – 50 seats",                impact: 15000,  impactStr: "$15K",  impactSub: "Renewal",       owner: "Irene Tan",    ownerRole: "IT",          evidenceDocs: 4,  proofTrail: "PT-1233", status: "Review",   due: "Tomorrow 11:30 AM",  dueUrgent: false, agent: "IT Guardian",       agentVer: "v1.5", confidence: 84 },
  { id: "AQ-017", priority: "High",   urgency: "Due soon", title: "Write off aged receivable",        sub: "Acme Corp – $42,500",                impact: 42500,  impactStr: "$42.5K",impactSub: "Write-off",     owner: "Daniel Tran",  ownerRole: "Finance",     evidenceDocs: 6,  proofTrail: "PT-1243", status: "Due soon", due: "2h 5m",              dueUrgent: false, agent: "Finance Watcher",   agentVer: "v2.1", confidence: 85 },
  { id: "AQ-018", priority: "Low",    urgency: "Review",   title: "Approve new vendor onboarding",    sub: "CloudScale LLC",                     impact: 18000,  impactStr: "$18K",  impactSub: "First year",    owner: "James Silva",  ownerRole: "Procurement", evidenceDocs: 9,  proofTrail: "PT-1241", status: "Review",   due: "4h 32m",             dueUrgent: false, agent: "Vendor Risk",       agentVer: "v1.6", confidence: 81 },
];
...
// Command Center Redesign Data
export const ccSystemHealth = [
  { name: "Supabase Database", status: "Healthy", uptime: "99.9%", icon: "Database" },
  { name: "AI Provider (Gemini 1.5 Pro)", status: "Healthy", uptime: "99.8%", icon: "Sparkles" },
  { name: "Document Parser", status: "Healthy", uptime: "100%", icon: "FileText" },
  { name: "Email Connector", status: "Degraded", uptime: "98.2%", icon: "Mail" },
  { name: "ERP Connector", status: "Healthy", uptime: "99.4%", icon: "Server" },
  { name: "CRM Connector", status: "Healthy", uptime: "99.7%", icon: "Users" },
  { name: "Storage Service", status: "Healthy", uptime: "99.9%", icon: "HardDrive" },
  { name: "Real-time Service", status: "Healthy", uptime: "99.9%", icon: "Activity" },
];

export const ccRiskExposure = [
  { level: "Critical", amount: 1350000, pct: 54, color: "var(--critical)" },
  { level: "High", amount: 640000, pct: 26, color: "var(--warning)" },
  { level: "Medium", amount: 320000, pct: 13, color: "var(--evidence)" },
  { level: "Low", amount: 170000, pct: 7, color: "var(--primary)" },
];

export const ccValueCaptured = {
  total: 1370000,
  delta: "+ $420k vs last 7d",
  breakdown: [
    { label: "Savings realized", value: 620000, color: "var(--primary)" },
    { label: "Losses prevented", value: 420000, color: "var(--evidence)" },
    { label: "Cost avoidance", value: 210000, color: "var(--foreground)" },
    { label: "Cash recovered", value: 120000, color: "var(--warning)" },
  ]
};

export const ccEvidenceCoverage = {
  sources: 95,
  extractedFacts: 2841,
  verifiedFacts: 1972,
  coverage: 87,
  staleSources: 12,
  byType: [
    { label: "Contracts", value: 42, pct: 44, color: "var(--primary)" },
    { label: "Invoices", value: 28, pct: 29, color: "var(--evidence)" },
    { label: "Emails", value: 15, pct: 16, color: "var(--warning)" },
    { label: "Reports", value: 10, pct: 11, color: "var(--critical)" },
  ]
};

export const ccActivityStream = [
  { id: "a1", type: "risk", title: "AI detected price variance in Office Supplies contract", sub: "$7,650 impact identified", time: "2m ago" },
  { id: "a2", type: "success", title: "Credit note CN-2025-0712 matched and verified", sub: "$413.50 adjustment confirmed", time: "7m ago" },
  { id: "a3", type: "agent", title: "Procurement Agent created PO-2025-1943", sub: "Vendor: Global Produce", time: "14m ago" },
  { id: "a4", type: "risk", title: "Microsoft EA Renewal requires approval", sub: "$120,000 potential impact", time: "18m ago" },
  { id: "a5", type: "success", title: "Data source 'vendor_benchmarks' refreshed", sub: "142 new records", time: "22m ago" },
];

export const ccRequiresAttention = [
  { id: "ra1", issue: "Renewal above market", entity: "Microsoft EA renewal", impact: 120000, impactType: "Potential loss", priority: "Critical", owner: "Michael Wong", ownerInitials: "MW" },
  { id: "ra2", issue: "Contract missing clause", entity: "Acme - Vendor X", impact: 35000, impactType: "Risk exposure", priority: "High", owner: "Sarah Miller", ownerInitials: "SM" },
  { id: "ra3", issue: "Duplicate payments", entity: "Global Produce", impact: 16400, impactType: "Overpayment", priority: "High", owner: "David Patel", ownerInitials: "DP" },
  { id: "ra4", issue: "Price variance detected", entity: "Office Supplies", impact: 7650, impactType: "Variance", priority: "Medium", owner: "Lena Nguyen", ownerInitials: "LN" },
  { id: "ra5", issue: "Approval overdue", entity: "PO-2025-1943", impact: null, impactType: "Blocked", priority: "Medium", owner: "Alex Rivera", ownerInitials: "AR" },
];
